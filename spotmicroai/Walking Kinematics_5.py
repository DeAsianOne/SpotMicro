...
def stand_phase(x_stand, z_stand, L1, L2):
...
def rear_left_swing(L1, L2, f):
    ...
    while x_rear_left <= 1.5:
        ...
        rear_shoulder_right, rear_leg_right, rear_feet_right = stand_phase(x_rear_right, leg_height_right, L1, L2)
        front_shoulder_left, front_leg_left, front_feet_left = stand_phase(x_front_left, leg_height_left, L1, L2)
        front_shoulder_right, front_leg_right, front_feet_right = stand_phase(x_front_right, leg_height_right, L1, L2)
        x_rear_left += 0.06
        x_rear_right -= 0.02
        x_front_left -= 0.02
        x_front_right -= 0.02
        row = [shoulder_front, rear_leg_left, rear_feet_left, shoulder_front, 180 - (rear_leg_right), 180 - (rear_feet_right), shoulder_rear, front_leg_left-10, front_feet_left-10, shoulder_rear, 180 - (front_leg_right-10), 180 - (front_feet_right-10)]
        writer.writerow(row)
        print(row)
    while shoulder_rear <= 90:
        rear_shoulder_left, rear_leg_left, rear_feet_left = stand_phase(x_rear_left, leg_height_left, L1, L2)
        rear_shoulder_right, rear_leg_right, rear_feet_right = stand_phase(x_rear_right, leg_height_right, L1, L2)
        front_shoulder_left, front_leg_left, front_feet_left = stand_phase(x_front_left, leg_height_left, L1, L2)
        front_shoulder_right, front_leg_right, front_feet_right = stand_phase(x_front_right, leg_height_right, L1, L2)
        shoulder_rear += 0.3
        shoulder_front -= 0.3
        leg_height_right -= 0.08
        leg_height_left += 0.08
        row = [shoulder_front, rear_leg_left, rear_feet_left, shoulder_front, 180 - (rear_leg_right), 180 - (rear_feet_right), shoulder_rear, front_leg_left-10, front_feet_left-10, shoulder_rear, 180 - (front_leg_right-10), 180 - (front_feet_right-10)]
        writer.writerow(row)
        print(row)
